...
New-HTMLTab [[-HtmlData] <ScriptBlock>] [[-Heading] <String>] [-Name <String>] [-IconBrands <String>]
 [-TextSize <Int32>] [-TextColor <RGBColors>] [-IconSize <Int32>] [-IconColor <RGBColors>] [<CommonParameters>]
```
