...
## 1.36.0
### What's new
- Improvements to null handlings in New-HTMLTable

**Full Changelog**: https://github.com/EvotecIT/PSWriteHTML/compare/v1.35.0...v1.36.0

## 1.33.0
### What's Changed
- Improve Gages by @PrzemyslawKlys in https://github.com/EvotecIT/PSWriteHTML/pull/498
	- adds new features to gages
	- closes #472 adding ability to define sectors in absolute values
	- added lots of other options
	- added more examples

**Full Changelog**: https://github.com/EvotecIT/PSWriteHTML/compare/v1.32.0...v1.33.0

## 1.32.0
### What's Changed
- Refactor New-HTMLTable.ps1 to enhance table by @PrzemyslawKlys in https://github.com/EvotecIT/PSWriteHTML/pull/497
...
## 1.31.0
### What's Changed
* Improve InfoCard by @PrzemyslawKlys in https://github.com/EvotecIT/PSWriteHTML/pull/495

**Full Changelog**: https://github.com/EvotecIT/PSWriteHTML/compare/v1.30.0...v1.31.0

## 1.30.0

### What's Changed
- Added `New-HTMLDate`
- Added `Height` to `New-HTMLPanel` for better control
- Update `JustGage JS library` version to 1.7.0
- Allow setting `Width` in `New-HTMLTable` - resolves [#469](https://github.com/EvotecIT/PSWriteHTML/issues/469)

## 1.29.0
### What's Changed
- improve `New-HTML` to allow Minify/Format when not saving to file

## 1.28.0
### What's Changed
- fixed Get-HTMLLogos missing `$LogoPath` by @Binomimus in https://github.com/EvotecIT/PSWriteHTML/pull/466
...
## New Contributors
* @Binomimus made their first contribution in https://github.com/EvotecIT/PSWriteHTML/pull/466

## 1.27.0
### What's Changed
- Improve `New-HTML` utf-8 and lang properties for proper HTML specification
- Fixes [Linking Diagram with Tables by using New-DiagramEvent is currently broke #449](https://github.com/EvotecIT/PSWriteHTML/issues/449)
* Fix case-sensitivity for ChangeLog in readme.md by @cksapp in https://github.com/EvotecIT/PSWriteHTML/pull/447

### New Contributors
* @cksapp made their first contribution in https://github.com/EvotecIT/PSWriteHTML/pull/447

**Full Changelog**: https://github.com/EvotecIT/PSWriteHTML/compare/v1.26.0...v1.27.0

## 1.26.0 - 2024.07.06
* Added help to all PowerShell functions lacking it. by @neztach in https://github.com/EvotecIT/PSWriteHTML/pull/446

### New Contributors
* @neztach made their first contribution in https://github.com/EvotecIT/PSWriteHTML/pull/446
...
## 0.0.171 - 2022.03.02
  - Fixes problem with Comparing objects in `New-HTMLTable` and `Out-HTMLView`
## 0.0.170 - 2022.02.14
