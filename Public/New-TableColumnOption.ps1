...
function New-TableColumnOption {
    ...
    If ($PSBoundParameters['Width'] -ne $null) { $TableColumnOptionProperty.width = $Width }
    If ($PSBoundParameters['Hidden'] -ne $null) { $TableColumnOptionProperty.visible = !$Hidden }
    If ($PSBoundParameters['Searchable'] -ne $null) { $TableColumnOptionProperty.searchable = $Searchable }
    If ($PSBoundParameters['Sortable'] -ne $null) { $TableColumnOptionProperty.orderable = $Sortable }
