function New-HTMLTable {
    ...
    if (-not $Simplify) {
        ...
        $FilteringOutput = Add-TableFiltering -Filtering $Filtering -FilteringLocation $FilteringLocation -DataTableName $DataTableID -RegularExpression:$RegularExpression
