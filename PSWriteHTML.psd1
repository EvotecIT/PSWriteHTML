...
@{
    ...
    RequiredModules = @(@{ModuleName = 'PSSharedGoods'; GUID = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe'; ModuleVersion = '0.0.80'; })
    ...
    'TableButtonPrint', 'EmailTableButtonPrint', 'TableHeader', 
    'EmailTableHeader', 'TabOptions', 'HTMLText', 'Out-GridHtml', 'ohv'
