...
@{
    ...
    FunctionsToExport    = 'ConvertTo-CascadingStyleSheets', 'Email', 'EmailAttachment', 
    'EmailBCC', 'EmailBody', 'EmailCC', 'EmailFrom', 'EmailHeader', 'EmailHTML', 
    'EmailListItem', 'EmailOptions', 'EmailReplyTo', 'EmailServer', 
    'EmailSubject', 'EmailText', 'EmailTextBox', 'EmailTo', 
    'New-CalendarEvent', 'New-ChartAxisX', 'New-ChartAxisY', 'New-ChartBar', 
    'New-ChartBarOptions', 'New-ChartDonut', 'New-ChartGrid', 
    'New-ChartLegend', 'New-ChartLine', 'New-ChartPie', 'New-ChartRadial', 
    'New-ChartTheme', 'New-ChartToolbar', 'New-DiagramEvent', 
    'New-DiagramLink', 'New-DiagramNode', 'New-DiagramOptionsInteraction', 
    'New-DiagramOptionsLayout', 'New-DiagramOptionsLinks', 
    'New-DiagramOptionsManipulation', 'New-DiagramOptionsNodes', 
    'New-DiagramOptionsPhysics', 'New-GageSector', 
    'New-HierarchicalTreeNode', 'New-HTML', 'New-HTMLCalendar', 
    'New-HTMLChart', 'New-HTMLCodeBlock', 'New-HTMLContainer', 
    'New-HTMLDiagram', 'New-HTMLFooter', 'New-HTMLGage', 'New-HTMLHeader', 
    'New-HTMLHeading', 'New-HTMLHierarchicalTree', 
    'New-HTMLHorizontalLine', 'New-HTMLImage', 'New-HTMLList', 
    'New-HTMLListItem', 'New-HTMLLogo', 'New-HTMLMain', 'New-HTMLPanel', 
    'New-HTMLPanelOption', 'New-HTMLSection', 'New-HTMLSectionOption', 
    'New-HTMLSpanStyle', 'New-HTMLStatus', 'New-HTMLStatusItem', 
    'New-HTMLTab', 'New-HTMLTable', 'New-HTMLTabOption', 'New-HTMLTag', 
    'New-HTMLText', 'New-HTMLTimeline', 'New-HTMLTimelineItem', 
    'New-HTMLToast', 'New-HTMLTree', 'New-TableButtonCopy', 
    'New-TableButtonCSV', 'New-TableButtonExcel', 
    ...
    'DiagramOptionsPhysics', 'HierarchicalTreeNode', 'Dashboard', 
    'Calendar', 'Chart', 'Container', 'Diagram', 'Footer', 'Header', 'Image', 
    'EmailList', 'Main', 'New-HTMLColumn', 'Panel', 'New-HTMLPanelOptions', 
    'New-PanelOption', 'PanelOption', 'New-HTMLContent', 'Section', 
    'New-HTMLSectionOption', 'SectionOption', 'Tab', 'Table', 'EmailTable', 
    'TabOptions', 'New-TabOption', 'New-HTMLTabOptions', 'TabOption', 
    ...
    'New-HTMLTableButtonPrint', 'EmailTableColumnOption', 
    'TableColumnOption', 'New-HTMLTableColumnOption', 
