...
@{
    ...
    #SRequiredModules = @(@{ModuleName = 'PSSharedGoods'; GUID = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe'; ModuleVersion = '0.0.104'; })
    ...
    FunctionsToExport = 'New-CalendarEvent', 'New-ChartAxisX', 'New-ChartAxisY', 'New-ChartBar', 
    ...
    'New-DiagramOptionsPhysics', 'New-HierarchicalTreeNode', 'New-HTML', 
    'New-HTMLCalendar', 'New-HTMLChart', 'New-HTMLCodeBlock', 
    'New-HTMLContainer', 'New-HTMLDiagram', 'New-HTMLHeading', 
    ...
    'New-HTMLTimelineItem', 'New-HTMLToast', 'New-TableButtonCopy', 
    ...
    'New-TableHeader', 'New-TableReplace', 'Out-HtmlView', 'Save-HTML'
    ...
    'Diagram', 'Image', 'New-HTMLColumn', 'Panel', 'New-HTMLContent', 'Section', 
    'Tab', 'Table', 'EmailTable', 'TabOptions', 'HTMLText', 'Text', 
