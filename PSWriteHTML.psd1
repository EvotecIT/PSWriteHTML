...
FunctionsToExport = 'Add-HTMLHorizontalLine', 'Add-HTMLImage', 'Get-HTMLBarChart', 
               ...
               'Get-HTMLPieChart', 'Get-HTMLPieChartObject', 'Get-HTMLStackedChart', 
               'Get-HTMLStackedChartObject', 'New-Html', 'New-HTMLAnchor', 
               'Get-HTMLAnchorLink', 'Get-HTMLAnchor', 'New-HTMLBarChart', 
               'New-HTMLChartObject', 'New-HTMLChartsDataSet', 'New-HTMLCodeBlock', 
               'New-HTMLColumn', 'New-HTMLContent', 'New-HTMLHeading', 'New-HtmlTab', 
               'New-HTMLTabHeader', 'New-HTMLTag', 'Save-HTML', 'Set-TableRowColor'
...
AliasesToExport = 'Get-HTMLTabHeader'
