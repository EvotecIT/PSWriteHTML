...
@{
    ...
    RequiredModules = @(@{ModuleName = 'PSSharedGoods'; GUID = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe'; ModuleVersion = '0.0.102'; })
    ...
    'New-ChartTheme', 'New-ChartToolbar', 'New-DiagramNode', 
    'New-DiagramOptionsInteraction', 'New-DiagramOptionsManipulation', 
    'New-HTML', 'New-HTMLAnchor', 'New-HTMLAnchorLink', 
    'New-HTMLAnchorName', 'New-HTMLChart', 'New-HTMLCodeBlock', 
    ...
    'New-HTMLTableContent', 'New-HTMLTableHeader', 'New-HTMLTableReplace', 
    ...
    'DiagramNode', 'DiagramOptionsInteraction', 
    'DiagramOptionsManipulation', 'Chart', 'Diagram', 'Image', 
    'New-HTMLColumn', 'New-HTMLContent', 'Table', 'EmailTable', 
    ...
    'TabOptions', 'HTMLText', 'Out-GridHtml', 'ohv'
