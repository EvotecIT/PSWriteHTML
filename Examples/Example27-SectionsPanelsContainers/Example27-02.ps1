...
New-HTML -TitleText 'My title' -Online -FilePath $PSScriptRoot\Example27-02.html -Show {
    ...
    $SectionStyle2 = New-HTMLSectionOption -RemoveShadow -BorderRadius 0px -Direction row -WritingMode vertical-lr -TextOrientation upright -RequestConfiguration -AlignContent flex-end -Align flex-end
    $SectionStyle3 = New-HTMLSectionOption -RemoveShadow -BorderRadius 0px -Direction row -WritingMode vertical-lr -RequestConfiguration -BackgroundColorContent Yellow
    $SectionStyleHidden = New-HTMLSectionOption -DirectionContent row -WrapContent wrap -RequestConfiguration -BorderRadius 0px
