...
New-HTML {
    ...
    New-HTMLPage -Name 'Page3' {
        New-HTMLSection {
            New-HTMLFrame -SourcePath (Join-Path -Path (Split-Path -Parent $PSScriptRoot) -ChildPath 'Example-InlineOtherHTMLFile.ps1/GroupMembership-CriticalGroups_2021-05-20_002030.html')
