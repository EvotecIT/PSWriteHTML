...
New-HTML -TitleText 'My title' -Online -FilePath $PSScriptRoot\Example-Tabs07.html -Show {
    #New-HTMLTabOption -SlimTabs         -BorderBottomStyleActive solid -BorderBottomColorActive LightSkyBlue -BackgroundColorActive none         -TextColorActive Black -Align left -BorderRadius 0px -RemoveShadow -TextColor Grey -TextTransform capitalize
    #New-HTMLTabOption -Wrap wrap-reverse -Direction row-reverse
    New-HTMLTabOption -RowElements 4
