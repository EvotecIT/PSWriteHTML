...
New-HTML -TitleText 'My title' -Online -FilePath $PSScriptRoot\Example-Tabs04.html -Show {
    New-HTMLTabOption -SlimTabs -Transition -LinearGradient -SelectorColor Gold -SelectorColorTarget AliceBlue -BorderRadius 25px -BorderBackgroundColor BurntOrange
