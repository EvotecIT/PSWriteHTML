...
New-HTML -TitleText 'My title' -Online -FilePath $PSScriptRoot\Example-Tabs04.html -Show {
    New-HTMLTabStyle -SlimTabs -Transition -LinearGradient -SelectorColor Gold -SelectorColorTarget AliceBlue -BorderRadius 25px -BorderBackgroundColor BurntOrange
