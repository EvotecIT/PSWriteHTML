...
} -ShowHTML -FilePath $PSScriptRoot\Example-IncludeExcludeProperties1.html -Online

New-HTML {
    New-HTMLTable -DataTable $DataTable1 -ExcludeProperty 'DateTest', 'DateUs'
} -ShowHTML -FilePath $PSScriptRoot\Example-IncludeExcludeProperties2.html -Online

New-HTML {
    New-HTMLTable -DataTable $DataTable1 {
        New-TableColumnOption -ColumnIndex 0, 1, 2 -Hidden $true
    }
} -ShowHTML -FilePath $PSScriptRoot\Example-IncludeExcludeProperties3.html -Online