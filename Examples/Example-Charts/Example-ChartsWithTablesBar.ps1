...
New-HTML {
    New-HTMLSection -HeaderText 'Donut Charts - Defaults' -CanCollapse {
        ...
        New-HTMLPanel {
            ...
            New-HTMLTable -DataTable $DataTable -DataTableID 'DifferentID' -SearchBuilder
            New-HTMLChart {
                New-ChartToolbar -Download
                ...
                New-ChartEvent -DataTableID 'DifferentID' -ColumnID 0
            }
        }
        New-HTMLPanel {
            $DataTable = @(
            ...
            New-HTMLTable -DataTable $DataTable -DataTableID 'TableID213' -SearchHighlight
            New-HTMLChart {
                New-ChartToolbar -Download
                ...
                New-ChartEvent -DataTableID 'TableID213' -ColumnID 0
            }
        }
    }
} -ShowHTML -FilePath $PSScriptRoot\Example-ChartsWithTablesBar.html -Online #-Format